...
class Settings:
    ...
    # follow_back_timeout_hours (168h/7 days) from the *original* Follow Requested At, the lead is
    # unfollowed. Global/shared across SP1-3, same as every other account-level setting.
